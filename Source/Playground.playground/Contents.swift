...
@resultBuilder struct TableBuilder {
    ...
    static func build<S: StateProtocol, E: EventProtocol>(@TableBuilder _ content: () -> ([Transition<S, E>])) -> [Transition<S, E>] {
        content()
    }
}
